...
class JadwalKonsultasi {
    ...
    tampilInformasi() {
        console.log(`${this.dokter.nama} berspesialisasi ${this.spesialisasi} sedang menagani pasien bernama ${this.pasien} yang berusia ${this.usia} pada pukul ${this.WaktuKonsultasi}`)
    }
}
