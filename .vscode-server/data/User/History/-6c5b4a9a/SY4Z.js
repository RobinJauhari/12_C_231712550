...
class JadwalKonsultasi {
    ...
    tampilInformasi() {
        console.log(`${this.dokter.nama} berspesialisasi ${this.dokter.spesialisasi} sedang menangani pasien bernama ${this.pasien.nama} yang berusia ${this.pasien.usia} pada pukul ${this.WaktuKonsultasi}`)
    }
}
