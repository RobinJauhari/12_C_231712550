...
class JadwalKonsultasi {
    ...
    tampilInformasi() {
        console.log(`${this.dokter.nama} berspesialisasi ${this.dokter.spesialisasi} sedang menagani pasien ${this.pasien.nama} berusia ${this.pasien.usia} pada pukul ${this.WaktuKonsultasi}`)
    }
}
