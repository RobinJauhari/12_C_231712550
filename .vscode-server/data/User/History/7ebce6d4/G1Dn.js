class Perpustakaan {
    ...
    pinjamBuku(...args) {
        ...
        var pinjam2 = function (judul, namaPeminjam, tanggal, pukul) {
            return console.log(`${namaPeminjam} meminjam buku "${judul}" pada tanggal ${tanggal} pada pukul ${pukul}`);
        };
...
perpustakaan.pinjamBuku("Pangeran Kecil", "Budi", "10 Agustus", "10 pagi");